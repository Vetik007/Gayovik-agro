        ...
        <AboutInfoWrapper>
          ...
          <AboutInfo>
            <AboutText>
              ...
              сільськогосподарській галузі. Гайовик-агро є найбільшим
              дистриб`ютором сільськогосподарської та будівельної техніки в США
              та одним з найбільших імпортерів і дистриб`юторів такого
              обладнання у світі. Основними партнерами Гайовик-агро є відомі
              бренди, серед яких Claas, Lemken, Kuhn, INA, Timken, SKF, Avia,
              Gates.
            </AboutText>
            <AboutInfoList>
              <AboutInfoItem>
